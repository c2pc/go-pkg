...
func ExampleDriver() {
	// see config/stub for an example

	// config/stub/stub.go has the driver implementation
	// config/stub/stub_test.go runs config/testing/test.go:Test
}

// Using config/stub here is not possible as it
