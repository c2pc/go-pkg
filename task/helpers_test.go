...
func TestMassDelete(t *testing.T) {
	...
	msg, err := task.MassDelete(ctx, data, notFoundError, idsFn, pluckIDsFn, actionFn)
...
func TestMassUpdate(t *testing.T) {
	...
	msg, err := task.MassUpdate(ctx, data, notFoundError, idsFn, pluckIDsFn, actionFn)
...
func TestImport(t *testing.T) {
	...
	msg, err := task.Import(ctx, data, dataFn, actionFn)
...
func TestExport(t *testing.T) {
	...
	msg, err := task.Export(ctx, data, emptyListError, listFn, actionFn)
...
func TestMassDelete_InvalidJSON(t *testing.T) {
	...
	msg, err := task.MassDelete(ctx, data, errors.New("not found"), idsFn, pluckIDsFn, actionFn)
...
func TestMassUpdate_PluckIDsFnError(t *testing.T) {
	...
	msg, err := task.MassUpdate(ctx, data, errors.New("not found"), idsFn, pluckIDsFn, actionFn)
