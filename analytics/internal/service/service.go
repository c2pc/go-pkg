...
type AnalyticService interface {
	List(ctx context.Context, m *model2.Meta[model.Analytics]) error
	GetById(ctx context.Context, id int) (*model.Analytics, error)
}
...
func (a Analytic) List(ctx context.Context, m *model2.Meta[model.Analytics]) error {
	return a.analyticRepository.With("user").Omit("request_body", "response_body").Paginate(ctx, m, ``)
}

func (a Analytic) GetById(ctx context.Context, id int) (*model.Analytics, error) {
